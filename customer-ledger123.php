       ...
       <tr>  
                   <td valign="top"  align="left" id="combind_payment-due_div2" style=" display:block; width:100%">
                       ...
                       <tr>
                          ...
                          <!-- <input type="text" id="combind_payment_due_amount" style="width:250px;"  name="combind_payment_due_amount" value="" onkeydown="combind_payment_due_calculation()" onkeyup="combind_payment_due_calculation()" onkeypress="combind_payment_due_calculation()" />
                           <span id=""  style="color:red;" >-->
                           <!--(Due :<input type="text" id="combind_payment_due_amount_new_due" style="width:60px;color:red;border:0;" readonly="readonly"  name="combind_payment_due_amount_new_due" value="" />--></span>
 ...
 <div class="u-layout-row" id="profile_div_1" name="profile_div_1" style="display:none;">
          <div class="u-align-left u-container-style u-layout-cell u-size-60 u-layout-cell-1" style="padding-right:0px;margin-bottom:0px; margin-top:px;">
            <div class="u-expanded-width u-layout-grid u-list u-list-1" style=""  >
              ...
              <table width="100%">
           <!--     <tr><td><h4 class="u-text-2 u-text-palette-1-base1 " style="padding:0px; margin:0px;">Profile Details :</h4>
              </td></tr>-->
                <tr><td>
                    <?php 
            ...
            if($select_total > 0)
            {
                ...
                while($select_data = mysql_fetch_array($select_result))
                {
                    ...
                    if($im==1)
                    {
                        ...
                        <td class="data data_fixed top_40 bg_w"  width="50px"><b><?php echo $tds_tot_due; ?></b></td>
                        <td class="data data_fixed top_40 bg_w" width="50px"><b><?php echo $total_gst_amount."&nbsp;"; 
                        echo $gst_tot_due; ?></b></td>
                        <td class="data data_fixed top_40 bg_w" width="50px"><b><?php echo $invoice_tot_due;  ?></b></td>
