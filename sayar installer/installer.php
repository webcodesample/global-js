...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20230923_sayarltd_1ad254411f0e64146016_20230923125506_archive.zip';
        const ARCHIVE_SIZE       = '50058676';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '1ad2544-23125506';
        const SECONDARY_PACKAGE_HASH = '2897fd4-23125506';
        const VERSION            = '1.5.6';
