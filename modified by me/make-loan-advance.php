...
*/
	...
	$msg = "Make Loan And Advance Payment successfully.";
	$flag = 1;
	
}
/*/$qry_max=" select max(advance_loan_no) as max_loan_id from payment_plan";
$qry_max=" select count(advance_loan_no) as advance_loan_no_count from payment_plan where advance_loan_no>0";
$qry_max_result = mysql_query($qry_max);       
$qry_max_row = mysql_fetch_array($qry_max_result);
if($qry_max_row[advance_loan_no_count]<1)
{
    $loan_id_new="M-1001";       
}else{
$loan_id_new ="M-".$qry_max_row[advance_loan_no_count]+1000;    
}*/

//code by amit
$advance_loan_count_sql = "SELECT COUNT(*) as advance_loan_count from payment_plan WHERE LENGTH(advance_loan_no)>1";
$advance_loan_count_result = mysql_query($advance_loan_count_sql);

$advance_loan_counter = mysql_fetch_array($advance_loan_count_result);

if($advance_loan_counter[advance_loan_count]<1)
{
    $loan_id_new="M-1001";       
}else{
$loan_id_new ="M-".($advance_loan_counter[advance_loan_count]+1000);
}
...
<body  data-home-page-title="" class="u-body u-xl-mode" data-lang="en">
  ...
  <?php include_once("main_heading_open.php") ?>
    ...
    <tr>
		...
		Make Loan And Advances payment </h4>
  </td>
  ...
  <table width="100%" class="tbl_border" >
	...
	<form name="payment_form" id="payment_form" action="" method="post" enctype="multipart/form-data" >
		...
		<tr>
			...
			<td><input type="text"  name="amount" id="amount" value="" style="width:250px;" />&nbsp;<span style="color:#FF0000; font-weight:bold;"  >*</span></td></tr>
                ...
                <td colspan="2">
                    ...
                    <table>
                        <tr>
                            ...
                            <td><input type="text"  name="pay_checkno" id="pay_checkno" value=""  style="width:250px;"/><br></td>
                        </tr>
                    </table>
			...
			<td><input type="text" id="attach_file_name"  name="attach_file_name" style="width:250px;" value="" autocomplete="off"/></td></tr>
            ...
            <td><input type="text"  name="interest" id="interest" value="" />&nbsp;<span style="color:#FF0000; font-weight:bold;"  ></span></td></tr>-->
			<tr><td></td><td>
