...
<?php include_once("main_search_open.php") ?>
  ...
  <form name="search_form1" id="search_form1" action="" method="post" onSubmit="return search_valid1();" enctype="multipart/form-data">
   ...
   <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
			 <tr>
					 <td width="480" align="left" valign="top">Project Name
					 &nbsp;&nbsp;&nbsp;&nbsp;
			...
			if($select_total > 0)
			{
				...
				while($select_data = mysql_fetch_array($select_result))
				{
					...
					<tr class="data">
						...
						<td class="data">&nbsp;&nbsp;<a href="project_subdivisionlist.php?project=<?php echo $select_data['id']; ?>" title="View Ledger"  ><?php echo $select_data['name']; ?></a></td>
