	...
	<form name="user_form" id="user_form" action="" method="post" >
		...
		<table class="data">
			<tr class="data">
				...
				<th class="data">Reg. No.</th>
                <th class="data">Invoice Display Name</th>
                <th class="data">Issuer Name</th>
				<th class="data">Our Invoice contact</th>
				<th class="data">Address</th>
                <th class="data">VAT No.</th>
				<th class="data">GST No. </th>
				<th class="data">CIN no.</th>
                <th class="data">PAN No.</th>
			...
			if($select_total > 0)
			{
				...
				while($select_data = mysql_fetch_array($select_result))
				{
					...
					<tr class="data">
                        ...
                        <td class="data"><?php echo $select_data['reg_no']; ?></td>
                        <td class="data"><?php echo $select_data['company_name']; ?></td>
						<td class="data"><?php echo $select_data['issuer_name']; ?></td>
						<td class="data"><?php echo $select_data['display_name']; ?></td>
						<td class="data"><?php echo $select_data['address']; ?></td>
						<td class="data"><?php echo $select_data['vat_no']; ?></td>
                        <td class="data"><?php echo $select_data['gst_no']; ?></td>
						<td class="data"><?php echo $select_data['cin_no']; ?></td>
                        <td class="data"><?php echo $select_data['pan_no']; ?></td>
