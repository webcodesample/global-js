...
<form name="search_form" id="search_form" action="" method="post">
    ...
    <table width="" border="1" align="left" cellpadding="0" cellspacing="0">
        ...
        <tr>
            ...
            {
                $option_list .= "<option value='".$row['issuer_name']." - ".$row['id']." - ".$row['gst_no']."'>".$row['issuer_name']."</option>";
            }
            echo $option_list;
            ?>
            </select>
            ...
            if($sales_total_row > 0)
            {
                ...
                while($sales_data = mysql_fetch_array($sales_result))
                {
                    ...
                    <tr class="data">
                        ...
                        <?php echo "<div style='width:100%; color:red;'>&#8377;&nbsp;".number_format(floatval($sales_data['credit']),2,'.','')."</div>"; ?>
                        </td>
                    </tr>
                <?php
                    $i++;
