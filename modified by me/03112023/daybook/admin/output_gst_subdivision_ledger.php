...
if(mysql_real_escape_string(trim($_REQUEST['search_action'])) == "withoutdate")
{
    ...
    if($_REQUEST['subdivision']!="All"){
     ...
     $select_query = "select *  from goods_details where  gst_subdivision = '".$_REQUEST['gst_subdivision_id']."' and gst_amount > '0' ".$customerdata." ".$projectdata."".$subdivisiondata." ORDER BY payment_date DESC,id DESC ";
    ...
    $select_query3_1 = "select SUM(gst_amount) as total_gst from goods_details  where  gst_subdivision = '".$_REQUEST['gst_subdivision_id']."' ".$customerdata." ".$projectdata."".$subdivisiondata."";
...
if(mysql_real_escape_string(trim($_REQUEST['search_action'])) == "enddate")
{
	...
	$select_query  = "select *  from goods_details where  gst_subdivision = '".$_REQUEST['gst_subdivision_id']."' and gst_amount > '0' and payment_date >= '".$from_date."' and payment_date <= '".$to_date."' ".$customerdata." ".$projectdata."".$subdivisiondata." ORDER BY payment_date DESC,id DESC ";
	...
	$select_total = mysql_num_rows($select_result);
                ...
                $select_query3_1 = "select SUM(gst_amount) as total_gst from goods_details  where  gst_subdivision = '".$_REQUEST['gst_subdivision_id']."' and gst_amount > '0' and payment_date <= '".$to_date."'  ".$customerdata." ".$projectdata."".$subdivisiondata."";
                ...
                $search_start ="1";
                 ...
                 $select_query3_2 = "select SUM(gst_amount) as total_gst from goods_details  where  gst_subdivision = '".$_REQUEST['gst_subdivision_id']."' and payment_date <= '".$from_date."' ".$customerdata." ".$projectdata."".$subdivisiondata."";
...
{
	$select_query = "select *  from goods_details where  gst_subdivision = '".$_REQUEST['gst_subdivision_id']."' and gst_amount > '0' ORDER BY payment_date DESC,id DESC ";
	$select_result = mysql_query($select_query) or die('error in query select bank query '.mysql_error().$select_query);
	$select_total = mysql_num_rows($select_result);
	
    $select_query3_1 = "select SUM(gst_amount) as total_gst from goods_details  where  gst_subdivision = '".$_REQUEST['gst_subdivision_id']."' ";
...
<body  data-home-page-title="" class="u-body u-xl-mode" data-lang="en">
  ...
  <?php include_once("main_heading_open.php") ?>
    ...
    <tr>
        ...
        Output GST subdivision - <?php echo get_field_value("name","gst_subdivision","id",$_REQUEST['gst_subdivision_id']); ?> Ledger</h4>
  </td>
        <td width="" style="float:right;">
        <input type="button" name="print_button" id="print_button" value="Print" class="button" onClick="return print_data();"  />
                        <a href="output_gst_subdivision.php" title="Back" ><input type="button" name="back_button" id="back_button" value="Back" class="button"  /></a>
                    <script src="dist/jquery.table2excel.min.js"></script>
                    <input type="button" id="export_to_excel" value="Export" class="button" >
...
<input type="hidden" name="gst_subdivision_id" id="gst_subdivision_id" value="<?php echo $_REQUEST['gst_subdivision_id']; ?>">
        ...
        <?php 
        $select_search1 = "select cust_id  from goods_details where  gst_subdivision = '".$_REQUEST['gst_subdivision_id']."' group BY cust_id ";
    ...
    $select_total1 = mysql_num_rows($search_result1);
        ...
        <option value="All">All</option>
        <?php 
        $select_search2 = "select project_id  from goods_details where  gst_subdivision = '".$_REQUEST['gst_subdivision_id']."' group BY project_id ";
    ...
    $select_total2 = mysql_num_rows($search_result2);
        ...
        <option value="All">All</option>
        <?php 
        $select_search3 = "select subdivision  from goods_details where  gst_subdivision = '".$_REQUEST['gst_subdivision_id']."' group BY subdivision ";
    $search_result3 = mysql_query($select_search3) or die('error in query select gst_subdivision query '.mysql_error().$select_search3);
    $select_total3 = mysql_num_rows($search_result3);
			...
			<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
				<tr>
				 ...
				 <td width="50">
                    ...
                    &nbsp;&nbsp;
                    <input type="button" name="search_button1" id="search_button1" value="search with date" onClick="return search_date();" class="button" ><br><br>                
                    
                    &nbsp;&nbsp;</td>
					<td align="right" valign="top" >
                        <input type="button" name="refresh" id="refresh" value="Refresh" class="button" onClick="window.location='output_gst_subdivision_ledger.php?gst_subdivision_id=<?php echo $_REQUEST['gst_subdivision_id']; ?>';"  />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <table class="data" id="my_table" border="1" cellpadding="1" cellspacing="0" style="border: 1px solid #111111;">
            ...
            <thead class="report-header">
				...
				<th class="data">Sub Division</th>
				<th class="data">Description</th>
				<th class="data" width="50">GST%</th>
				<th class="data" width="50">CGST</th>
                <th class="data" width="50">SGST</th>
				<th class="data" width="70">GST Amount</th>
                 ...
                 <tr class="data">
                       ...
                       <td class="data"></td>
                        ...
                        <?php $cgst1=$bal_1/2;
                                $sgst1 = $bal_1/2;
                         ?>
                        <td class="data"><?php     echo currency_symbol().number_format($cgst1,2,'.',''); ?>    </td>
                        <td class="data"><?php    echo currency_symbol().number_format($sgst1,2,'.',''); ?>    </td>
                        <td class="data" <?php if($bal_1<0) { ?> style="color:#FF0000;" <?php }else{?> style="color:#000000;" <?php } ?> ><?php  echo currency_symbol().number_format($bal_1,2,'.',''); ?> </td>
                      ...
                      //Project,Customer,Division,descri,gst%,cgst,sgst,total
					 ?>
					<tr class="data">
						...
						<td class="data"><?php	echo $select_data['gst_per']; ?>	</td>
                        
                        <?php $cgst=$select_data['gst_amount']/2;
                                $sgst = $select_data['gst_amount']/2;
                         ?>
                        <td class="data"><?php     echo currency_symbol().number_format($cgst,2,'.',''); ?>    </td>
                        <td class="data"><?php    echo currency_symbol().number_format($sgst,2,'.',''); ?>    </td>
						
						<td class="data" ><?php  echo currency_symbol().number_format($select_data['gst_amount'],2,'.',''); ?> 
...
?> 
                     ...
                     <tr class="data">
                       ...
                       <td class="data"></td>
                        ...
                        <?php $cgst2=$bal_2/2;
                                $sgst2 = $bal_2/2;
                         ?>
                        <td class="data"><?php     echo currency_symbol().number_format($cgst2,2,'.',''); ?>    </td>
                        <td class="data"><?php    echo currency_symbol().number_format($sgst2,2,'.',''); ?>    </td>
                        <td class="data" <?php if($bal_2<0) { ?> style="color:#FF0000;" <?php }else{?> style="color:#000000;" <?php } ?> ><?php  echo currency_symbol().number_format($bal_2,2,'.',''); ?> </td>
                        <td class="data" nowrap="nowrap"></td>                        
                    </tr>
			...
			else
			{
				?>
				<tr class="data" >
					<td  width="30px" colspan="11" class="record_not_found" >Record Not Found</td>
				</tr>
				<?php
			}
			?>
