...
<td>
<input type="text" name="client_contact_per" id="client_contact_per"  tabindex="18" value="<?php echo $select_data['client_contact_per']; ?>" style="width: 250px;">
</td>
</tr>
...
<br>&nbsp;<span id="sn_msg"></span>
		...
		<tr>
		   ...
		   <option value="tenant"  <?php if($select_data['customer_type']=="tenant"){ echo "selected='selected'"; } ?>>Tenant</option>
            ...
            <td><input type="text" id="current_maintenance"  name="current_maintenance" tabindex="23"  value="<?php echo $select_data['current_maintenance']; ?>" style="width: 250px;"/>&nbsp;</td>
            </tr>
