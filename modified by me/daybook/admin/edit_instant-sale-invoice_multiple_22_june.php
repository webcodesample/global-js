...
if(trim($_REQUEST['action_perform']) == "add_project")
{
   ...
   // $gst_subdivision = get_field_value("id","gst_subdivision","name",$_REQUEST['gst_subdivision']);
    ...
    $query2="update payment_plan set cust_id = '".$cust_id."', credit = '".$total_tot."',gst_amount = '".$gst_amount_tot."', description = '".$description."', on_project = '".$project_id."', payment_date = '".strtotime($_REQUEST['payment_date'])."',invoice_issuer_id = '".$invoice_issuer_id."',update_date = '".getTime()."' where  id = '".$id_first_cust."'";
  ...
  $gst_amount_perproject = $gst_amount[$i];
       ...
       //$old_id_check1
         if($old_new_check[$i]=="old"){
            $link_goods_details= $old_id_check1[$i];
                 ...
                 $query="update payment_plan set  on_customer = '".$cust_id."',payment_date = '".strtotime($_REQUEST['payment_date'])."', invoice_issuer_id = '".$invoice_issuer_id."',update_date = '".getTime()."' where  id = '".$old_link2_id[$i]."'";
               // echo $query;
                  //exit;
    $result2= mysql_query($query) or die('error in query '.mysql_error().$query);
    //$link_id_2 = $id_first_cust;
              $query="update goods_details set  cust_id = '".$cust_id."',payment_date = '".strtotime($_REQUEST['payment_date'])."', update_date = '".getTime()."' where  id = '".$link_goods_details."'";
    $result2= mysql_query($query) or die('error in query '.mysql_error().$query);   
    if($payment_flag==1){
    ...
    $result5= mysql_query($query5) or die('error in query '.mysql_error().$query5);
     ...
     $multi_project_id = $multi_project_id.$old_link2_id[$i].",";
                 ...
                 //   echo $project_id;
        //exit;
                    $query="insert into payment_plan set trans_id = '".$trans_id."', project_id = '".$project_id."',  invoice_id = '".$invoice_idnew."', debit = '".$sub_tot_perproject."', gst_amount = '".$gst_amount_perproject."', description = '".$desc_t[$i]."', hsn_code = '".$hsn_code[$i]."',on_customer = '".$cust_id."', payment_date = '".strtotime($_REQUEST['payment_date'])."',subdivision = '".$subdivision."',gst_subdivision = '".$gst_subdivision."',invoice_issuer_id = '".$invoice_issuer_id."',trans_type = '".$trans_type."', payment_flag = '".$payment_flag."',trans_type_name = '".$trans_type_name."', create_date = '".getTime()."'";
    //echo $query;
    //exit;
    ...
    $result5= mysql_query($query5) or die('error in query '.mysql_error().$query5);
        ...
        //$desc_total_n = $desc_total_n."(".$ij.")".$desc_t[$i].","; 
        $query_goods_details ="insert into goods_details set trans_id = '".$trans_id."',cust_id = '".$cust_id."', invoice_id = '".$invoice_idnew."',project_id = '".$project_id."',subdivision = '".$subdivision."',gst_subdivision = '".$gst_subdivision."',link1_id = '".$link_id_1."',link2_id = '".$link_id_2."',link3_id = '".$link_id_1_pay."',link4_id = '".$link_id_2_pay."', description = '".$desc_t[$i]."',hsn_code = '".$hsn_code[$i]."',qty = '".$qty_t[$i]."',unit_price = '".$unit_price_1[$i]."',gst_per = '".$gst[$i]."',gst_amount = '".$gst_amount[$i]."',sub_total = '".$sub_tot_perproject."',trans_type = '".$trans_type."',trans_type_name = '".$trans_type_name."',payment_date = '".strtotime($_REQUEST['payment_date'])."',create_date = '".getTime()."'";
...
<script>
 ...
 //qty_tot,unit_price_tot,sub_total_tot,total_tot,gst_amount_tot
   ...
   */  //project,subdivision,gst_subdivision
   var markup="<tr><td style='text-align: left;padding: 2px;'><input type='checkbox' name='record' class='case'/></td><td style='text-align: left;padding: 2px;'><span id='snum"+ii+"'>"+ii+".</span><input type='hidden' id='no_check"+ii+"' value='"+ii+"' name='no_check[]'/></td>";
    markup +="<td style='text-align: left;padding: 2px;'><input type='text' id='project"+ii+"' value='"+project2+"' name='project[]' style='width: 130px;' readonly='readonly'/></td><td style='text-align: left;padding: 2px;'><input type='text' id='subdivision"+ii+"' value='"+subdivision2+"' name='subdivision[]' style='width: 130px;' readonly='readonly'/></td><td style='text-align: left;padding: 2px;'><input type='text' id='gst_subdivision"+ii+"' value='"+gst_subdivision2+"' name='gst_subdivision[]' style='width: 130px;' readonly='readonly'/></td><td style='text-align: left;padding: 2px;'><input type='text' id='desc_t"+ii+"' value='"+desc2+"' name='desc_t[]' style='width: 140px;' readonly='readonly'/><td style='text-align: left;padding: 2px;'><input type='text' id='hsn_code"+ii+"' name='hsn_code[]' style='width: 70px;' readonly='readonly' value='"+hsn_code2+"'/></td></td> <td style='text-align: left;padding: 2px;'><input type='text' id='qty_t"+ii+"' name='qty_t[]' style='width: 30px;' readonly='readonly' value='"+qty2+"'/></td><td style='text-align: left;padding: 2px;'><input type='text' id='unit_price_1"+ii+"' value='"+unit_price2+"' style='width: 60px;' readonly='readonly' name='unit_price_1[]'/></td><td style='text-align: left;padding: 2px;'><input type='text' id='sub_total"+ii+"' value='"+sub_total2+"' style='width: 60px;' readonly='readonly' name='sub_total[]'/></td><td style='text-align: left;padding: 2px;'><input type='text' id='gst"+ii+"' value='"+gst2+"' style='width: 30px;' readonly='readonly' name='gst[]'/></td><td style='text-align: left;padding: 2px;'><input type='text' id='gst_amount"+ii+"' style='width: 60px;' readonly='readonly' value='"+gst_amount+"' name='gst_amount[]'/></td><td style='text-align: left;padding: 2px;'><input type='text' id='total"+ii+"' style='width: 60px;' readonly='readonly' value='"+total2+"' name='total[]'/></td><td style='color: red;' align='center'><input type='hidden' id='old_new_check"+ii+"' value='new' name='old_new_check[]'/>New</td></tr>";
...
<div id="wrapper">
  ...
  <script src="js/jquery-ui.js"></script>
      ...
      <table style="margin: 0px ; padding: 10px; border-radius: 10px;border: 1px solid #111111;">
            ...
            <tr><td >GST Division Name</td>
            <td>
             <input type="text" id="gst_subdivision_1"  name="gst_subdivision_1" value="" style="width:250px;"/>&nbsp;<span style="color:#FF0000; font-weight:bold;"  >
            &nbsp;<span style="color:#FF0000; font-weight:bold;"  >*</span>
        ...
        <?php
            ...
            // $select_gst = mysql_fetch_array($query_gst);
             ...
             { ?>
                <option value="<?php echo $row_gst['gst']; ?>"><?php echo $row_gst['gst']."%"; ?></option> 
          <?php    }
              ?>
           </select>
            &nbsp;<span style="color:#FF0000; font-weight:bold;"  >*</span>
 ...
 //qty_tot,unit_price_tot,sub_total_tot,total_tot,gst_amount_tot
  ...
  <tr>
    ...
    <td style='text-align: left;padding: 2px;'><input style="width: 130px;" readonly="readonly"  type='text' id="<?php echo "gst_subdivision$ii"; ?>" value="<?php echo $gst_subdivision1_nm; ?>"  name='gst_subdivision[]'/></td>
...
<input type="hidden" value="<?php echo $ii; ?>" id="i_val" name="i_val">
    ...
    <td style='text-align: left;padding: 2px;'><input style="width: 130px;" readonly="readonly"  type='text' id='desc_tot' value="Total Items"  name='desc_tot'/></td><td style='text-align: left;padding: 2px;'><input style="width: 130px;" readonly="readonly"  type='text' id='desc_tot' value="Total Items"  name='desc_tot'/></td><td style='text-align: left;padding: 2px;'><input style="width: 130px;" readonly="readonly"  type='text' id='desc_tot' value="Total Items"  name='desc_tot'/></td><td style='text-align: left;padding: 2px;'><input style="width: 140px;" readonly="readonly"  type='text' id='desc_tot' value="Total Items"  name='desc_tot'/></td>
