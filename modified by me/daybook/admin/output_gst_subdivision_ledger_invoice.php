...
<input type="hidden" name="gst_subdivision_id" id="gst_subdivision_id" value="<?php echo $_REQUEST['gst_subdivision_id']; ?>">
            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td width="100px">Customer List</td>
                    <td>
 ...
 <!-------------->
  ...
  <tr><td>
        ...
        <tr style="display:none ;">
            <td><b>GST Subdivision list:</b></td><td><b><?php echo get_field_value("name","gst_subdivision","id",$_REQUEST['gst_subdivision_id']); ?></b></td>
            <td><b>Customer list :</b></td><td><b><?php  $customer_nm = get_field_value("full_name","customer","cust_id",$_REQUEST['cust_id']); echo $customer_nm;   ?></b></td>
        ...
        <tr style="display:none ;">
            ...
            <thead class="report-header" style="height:70px;" >
				<th class="data"  style="font-size:10px;width:30px; position: sticky; top: 0;">S.<br>No.</th>
				...
				while($select_data = mysql_fetch_array($select_result))
				{
                 ...
                 <tr class="data">
					...
					<tr class="data">
						...
						<td class="data"><?php echo date("d-m-y",$select_data['payment_date']);
                        //echo date("d-m-y",'1648665000'); ?></td>
						<td class="data"><?php	
                        ...
                        //echo get_field_value("name","project","id",$select_data['project_id']); ?>	</td>
                        ...
                        //echo get_field_value("name","subdivision","id",$select_data['subdivision']); ?>   </td>
