    ...
    else
    {
        ...
        if($trans_t_name=="instmulti_sale_goods")
        {
            ...
            while($data_del_gst = mysql_fetch_array($result_del_gst))
            {
                ...
                $del_query_gst = "delete from gst_due_info where id = '".$data_del['id']."'";
            ...
            {
                $fnm = $data_del['cert_file_name'];
                $del_query_tds = "delete from tds_due_info where id = '".$data_del['id']."'";
            ...
            {
                $fnm = $data_del['cert_file_name'];
                $del_query_invoice = "delete from invoice_due_info where id = '".$data_del['id']."'";
...
<form name="edit_invoice_form1" id="edit_invoice_form1" action="edit_invoice_ledger_invoice.php" method="post" >
...
<form name="edit_tds_form1" id="edit_tds_form1" action="edit_invoice_ledger_tds.php" method="post" >
<!--edit_tds_form ,  info_tb_id, trsns_pname ,invoice_no , payment_id  -->
