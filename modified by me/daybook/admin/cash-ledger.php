...
<script src="dist/jquery.table2excel.min.js"></script>
  <?php include_once("main_heading_open.php") ?>
    ...
    <tr>
        ...
        Cash - <?php echo get_field_value("bank_account_name","bank","id",$_REQUEST['bank_id']); ?> Ledger </h4>
  </td>
        <td width="" style="float:right;">
            <a href="cash.php" title="Back" ><input type="button" name="back_button" id="back_button" value="" class="button_back"  /></a>&nbsp;<input type="button" name="print_button" id="print_button" value="" class="button_print" onClick="return print_data();"  />
...
<input type="hidden" id="print_header" name="print_header" value="Cash - <?php echo get_field_value("bank_account_name","bank","id",$_REQUEST['bank_id']); ?> Ledger">
...
<form name="search_form" id="search_form" action="" method="post" onSubmit="return search_valid();" >
            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                ...
                <!--    <input type="text" name="to_date" id="to_date" value="<?php echo $_REQUEST['to_date']; ?>"  readonly="" style="width:100px;" >-->
                    ...
                    <td align="left" valign="top" >&nbsp;&nbsp;<input type="submit" name="search_button" id="search_button" value="Search" class="button"  />&nbsp;&nbsp;<input type="button" name="refresh" id="refresh" value="Refresh" class="button" onClick="window.location='cash-ledger.php?bank_id=<?php echo $_REQUEST['bank_id']; ?>';"  /></td>
...
<?php include_once("main_search_close.php") ?>
  ...
  <?php include_once("main_body_open.php") ?>
        ...
        <tr style="display:none ;">
            <td><b>Cash Ledger :</b></td><td><b><?php echo get_field_value("bank_account_name","bank","id",$_REQUEST['bank_id']); ?></b></td>
        ...
        <td><b>Period Start :</b></td><td><b><?php if($_REQUEST['from_date']!=""){ echo date("d-m-Y",strtotime($_REQUEST['from_date']));  }?></b></td>
            ...
            <thead class="report-header">
                ...
                <th class="data" width="80"><b>Date</th>
                <th class="data"><b>To&nbsp; / From</th>
                <th class="data"><b>Project</th>
                <th class="data"><b>Description</th>
                <th class="data" width="50"><b>Debit</th>
                <th class="data" width="50"><b>Credit</th>
                <th class="data" width="70"><b>Balance</th>
                <th class="data noExl" id="header1"><b>File</b>
            </th>
                </thead>
            </tr>
            <?php
            if($select_total > 0)
            {
                ...
                //$select_query3 = "select SUM(debit) as total_debit,SUM(credit) as total_credit from payment_plan where bank_id = '".$_REQUEST['bank_id']."'   ";
                //$select_result3 = mysql_query($select_query3) or die('error in query select cash query '.mysql_error().$select_query3);
                //$select_data3 = mysql_fetch_array($select_result3);
                //echo $select_data3['total_credit']-$select_data3['total_debit'];
                //$bal=$select_data3['total_credit']-$select_data3['total_debit'];
...
?>
                    ...
                    <tr class="data">
                        ...
                        <?php    
                         ...
                         if($select_data['on_loan'] != "" && $select_data['on_loan'] != 0) { ?>
                        ...
                        {  ?>
                        <a href="edit_internal_transfer.php?trans_id=<?php echo $select_data['trans_id']; ?>&id=<?php echo $select_data['payment_id']; ?>&trsns_pname=<?php echo "cash-ledger"; ?>"><img src="mos-css/img/edit.png" title="Edit"></a>
                 <?php  } 
                         ?>
