...
if(trim($_REQUEST['action_perform']) == "add_payment")
{
    ...
    //$query="update  loan_advance_payment set  bank_id = '".$bank_id."',client_id = '".$client_id."',  credit = '".$amount."', description = '".$description."', payment_date = '".$payment_date."',payment_method = '".$pay_method."',payment_checkno = '".$pay_checkno."', interest_per = '".$interest."' ,update_date = '".getTime()."' where id='".$main_id."'";
   
   $query="update payment_plan set advance_loan_no = '".$loan_id_new."',on_loan = '".$client_id."', bank_id = '".$bank_id."', credit = '".$amount."', description = '".$description."',  payment_date = '".$payment_date."', payment_method = '".$pay_method."',payment_checkno = '".$pay_checkno."', interest_per = '".$interest."',update_date = '".getTime()."' where id='".$bank_entry_id."'";
    $result= mysql_query($query) or die('error in query '.mysql_error().$query);
    
    $link_id_1 = $bank_entry_id;
    
    $query2="update payment_plan set advance_loan_no = '".$loan_id_new."',loan_id = '".$client_id."', on_bank = '".$bank_id."',  debit = '".$amount."', description = '".$description."', payment_date = '".$payment_date."',payment_method = '".$pay_method."',payment_checkno = '".$pay_checkno."', interest_per = '".$interest."',update_date = '".getTime()."' where id='".$loan_entry_id."'";
	...
	$msg = "update Loan And Advance Receive Payment successfully.";
	$flag = 1;
...
<body  data-home-page-title="" class="u-body u-xl-mode" data-lang="en">
  ...
  <?php include_once("main_heading_open.php") ?>
    ...
    <tr>
        ...
        Update Receive Loan $ Advances Payment </h4>
  </td>
  ...
  <table width="100%" class="tbl_border" >
	...
	<div id="adddiv" >
        ...
        <tr>
            ...
            ?>
            <input type="text" id="from"  name="from" value="<?php echo $select_client['name']; ?>" style="width:250px;"/>&nbsp;<span style="color:#FF0000; font-weight:bold;"  >*</span></td></tr>
                ...
                <td colspan="2">
                    ...
                    <table>
                        <tr>
                            ...
                            <td><input type="text" style="width:250px;" name="pay_checkno" id="pay_checkno" value="<?php echo $select_data['payment_checkno']; ?>" /><br></td>
                        </tr>
                    </table>
                     <br>
                    </div>
          ...
          <!--  <tr><td align="left" valign="top" >Interest (%)</td>
            ...
            ?>
            <input type="text" id="to"  name="to" value="<?php echo $select_bank['bank_account_name'].' - '.$select_bank['bank_account_number']; ?>" style="width:250px;"/></td></tr>
		    <tr><td align="left" valign="top" >Date</td>
            <script src="js/datetimepicker_css.js"></script>
            <td><input type="text"  name="payment_date" style="width:250px;" id="payment_date" value="<?php echo date("d-m-Y",$select_data['payment_date']);  ?>" autocomplete="off" />&nbsp;<img src="js/images2/cal.gif" onClick="javascript:NewCssCal('payment_date')" style="cursor:pointer"/>&nbsp;<span style="color:#FF0000; font-weight:bold;"  >*</span></td></tr>
