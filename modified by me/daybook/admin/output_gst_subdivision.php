...
if(trim($_REQUEST['action_perform']) == "add_bank")
{
    ...
    {
        $query="insert into gst_subdivision set name = '".$gst_subdivision."' '";
             ...
             <link rel="stylesheet" href="css/jquery-ui.css" />
              ...
              <script src="js/jquery-ui.js"></script>
               <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                 <tr>
                         <td width="500" align="left" valign="top">Search By GST Subdivision Name
                         &nbsp;&nbsp;&nbsp;&nbsp;
                         ...
                         &nbsp;&nbsp;&nbsp;&nbsp;<input type="button" name="refresh" id="refresh" value="Refresh" class="button" onClick="window.location='output_gst_subdivision.php';"  />
                         </td>
                         </tr>
               </table>
            <br>
            ...
            if($select_total > 0)
            {
                ...
                $ii=$i+$startResults;    
                    ...
                    <tr class="data">
                        ...
                        <td class="data"><a href="output_gst_subdivision_ledger_invoice.php?gst_subdivision_id=<?php echo $select_data['id']; ?>" title="View Ledger"  ><?php echo $select_data['name']; ?></a></td>
                        <td class="data" <?php if(get_total($select_data['id'],strtotime(date("d-m-Y")))<0) { ?> style="color:#FF0000;" <?php } ?>>
                        <?php echo currency_symbol().number_format(get_total($select_data['id'],strtotime(date("d-m-Y"))),2);
