...
//$qry_max=" select max(loan_id) as max_loan_id from payment_plan";
//code by amit
...
$loan_id_new ="R-".($advance_loan_counter[advance_loan_count]+1000);
}
...
<h4 class="u-text-2 u-text-palette-1-base " style="padding:0px; margin:0px;">Receive Loan And Advances Payment </h4>
</td>
</tr>
</table>
	...
	<form name="payment_form" id="payment_form" action="" method="post" enctype="multipart/form-data" >
        ...
        <tr>
           ...
           <tr><td valign="top" >Attach File</td>
            ...
            <td>
            <input type="date"  name="payment_date" style="width:250px;" min="2020-04-01" max="<?= date('Y-m-d',time()) ?>">
            </td>
            </tr>
