...
<body  data-home-page-title="" class="u-body u-xl-mode" data-lang="en" onload="set_option()">
    ...
    <div id="adddiv" style="display:<?php if($error_msg != "") { ?>block<?php } else { ?>none<?php } ?>;">
        ...
        <table class="data" border="1" cellpadding="1" cellspacing="0" style="width:100%; border: 1px solid #111111;">
            ...
            <?php 
            echo getTime(); echo " ( By : "; $username_1=get_field_value($con,"full_name","user","userid",$userId); echo $username_1; echo " )";?>
            </b>
            </td>
        </tr>    
            <tr align="center">
        ...
        <tr class="data">
            ...
            <?php echo getTime(); echo " ( By : "; $username_1=get_field_value($con,"full_name","user","userid",$userId); echo $username_1; echo " )";?>
            </b>
            </td>
        </tr>    
            <tr align="center">
