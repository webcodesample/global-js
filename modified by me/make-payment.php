...
if(trim($_REQUEST['action_perform']) == "add_payment")
{
	...
	$query="insert into payment_plan set trans_id = '".$trans_id."', bank_id = '".$bank_id."', debit = '".$amount."', description = '".$description."', on_customer = '".$cust_id."', on_project = '".$project_id."', payment_date = '".$payment_date."', trans_type = '".$trans_type."', trans_type_name = '".$trans_type_name."',create_date = '".getTime()."'";
	$result= mysql_query($query) or die('error in query '.mysql_error().$query);
	
	$link_id_1 = mysql_insert_id();
	
	$query2="insert into payment_plan set trans_id = '".$trans_id."', cust_id = '".$cust_id."', credit = '".$amount."', description = '".$description."', on_project = '".$project_id."', on_bank = '".$bank_id."', payment_date = '".$payment_date."',link_id = '".$link_id_1."',trans_type = '".$trans_type."', trans_type_name = '".$trans_type_name."', create_date = '".getTime()."'";
...
<body  data-home-page-title="" class="u-body u-xl-mode" data-lang="en">
  ...
  <?php include_once("main_heading_open.php") ?>
    ...
    <tr>
        ...
        <h4 class="u-text-2 u-text-palette-1-base " style="padding:0px; margin:0px;">Make payment </h4>
  </td>
...
<?php include_once("main_heading_close.php") ?>
  <?php include_once("main_body_open.php") ?>
	...
	<tr>
			...
			<tr><td valign="top"  width="125px">Transaction ID</td>
			<td colspan="3" style="color:#FF0000; font-weight:bold;"><input type="hidden" id="trans_id"  name="trans_id" value="<?php echo $trans_id; ?>"/>&nbsp;<?php echo $trans_id; ?></td></tr>
			<tr>
				<td colspan="2" valign="top">
					<table width="100%" style="">
						
					<tr><td width="150px">From</td>
			<td><input type="text" id="from"  name="from" value="" style="width:250px;"/>&nbsp;<span style="color:#FF0000; font-weight:bold;"  >*</span></td></tr>
			<tr><td >Project</td>
			<td><input type="text" id="project"  name="project" value="" style="width:250px;"/></td></tr>
