...
*/
    ...
    else if($search_pay_type=="other_payment")
    {
        $pay_type1="and payment_type not like '%re%' and payment_type not like '%Mak%' and payment_type not like '%int%' and payment_type not like '%lad-re%' and payment_type not like '%lad-mak%'";
        $pay_type2="";
        $pay_type3="";
        $trans_flag_permision=1;
    }
...
{
	$select_query = "select * from tbl_info where file_import_id = '".$_REQUEST['file_id']."' ORDER BY payment_date DESC";
	$select_result = mysql_query($select_query) or die('error in query select bank query '.mysql_error().$select_query);
	$select_total = mysql_num_rows($select_result);
	$trans_flag_permision=0;
...
<body  data-home-page-title="" class="u-body u-xl-mode" data-lang="en">
  ...
  <?php include_once("main_heading_open.php") ?>
    ...
    <tr>
		...
		<a href="import_file.php" title="Back" ><input type="button" name="back_button" id="back_button" value="" class="button_back"  /></a>
...
<input type="hidden" name="file_id" id="file_id" value="<?php echo $_REQUEST['file_id']; ?>" >
			<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
				<tr>
                <td width="205" align="left" valign="top"> Search By Payment Type :</td>
                      ...
                      <option value="other_payment" <?php if($_REQUEST['search_pay_type']=="other_payment"){ echo "selected='selected'"; } ?> >Other</option>
     
                     </select>    
                      </td>
                      <td align="left" valign="top" >&nbsp;&nbsp;<input type="submit" name="search_button" id="search_button" value="Search" class="button"  />&nbsp;&nbsp;<input type="button" name="refresh" id="refresh" value="Refresh" class="button" onClick="window.location='import_file_permission.php?file_id=<?php echo $_REQUEST['file_id']; ?>';"  /></td>
...
<?php include_once("main_body_open.php") ?>
        ...
        <form name="search_form1" id="search_form1" action="" method="post" onSubmit="return search_valid();" enctype="multipart/form-data">
         ...
         <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
         <tr>
                <td width="105" align="left" valign="top"> Trans Category :</td>
                      <td width="180" align="left" valign="top">
                      <select name="trans_pay_type" id="trans_pay_type" style="width:250px; height: 25px;">
                      <option value="received_payment" <?php if($_REQUEST['search_pay_type']=="received_payment"){ echo "selected='selected'"; } ?> >Received Payment</option> 
                      <option value="make_payment" <?php if($_REQUEST['search_pay_type']=="make_payment"){ echo "selected='selected'"; } ?> >Make Payment</option>
                      <option value="internal_payment" <?php if($_REQUEST['search_pay_type']=="internal_payment"){ echo "selected='selected'"; } ?> >Internal Transfer</option>
                      <option value="lad_make_payment" <?php if($_REQUEST['search_pay_type']=="lad_make_payment"){ echo "selected='selected'"; } ?> >Loan-Adv Make Payment</option>
                      ...
                      <td align="left" valign="top" >&nbsp;&nbsp;<input type="submit" onClick="trans_valid();" name="search_button" id="search_button" value="Final Transfer" class="button"  /></td></tr>
         </table>
         <input type="hidden" name="search_action_trans" id="search_action_trans" value=""  />
			<?php } ?>
		...
		<table class="data" id="my_table" border="1" cellpadding="1" cellspacing="0" style="border: 1px solid #111111;">
            ...
            <thead class="report-header">
				...
				<th class="data" width="50"><b>Payment-Type</b></th>
				<th class="data" width="100"><b>Final Payment-type</b></th>
				...
				while($select_data = mysql_fetch_array($select_result))
				{
					...
					<tr class="data">
                       ...
                       <td class="data" align="center"><?php echo $select_data['file_series']; ?>	</td>
						...
						<td class="data"><?php echo $select_data['payment_type']; ?></td>
