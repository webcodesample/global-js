...
<table width="700" style="border-collapse:collapse;" cellpadding="0" cellspacing="0" border="0" bordercolor="#000000">
       ...
       <tr height="30">
            ...
            <tr>
                ...
                <td align="center">
                    Invoice No.&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $data1['invoice_id']; ?>
                    <br>
                    <table style="border-radius: 10px;border: 1px solid #111111;padding: 5px; width: 250px;height: 70px; font-size: 13;">
                    <tr>
                        <td width="90px;">P.A.N</td><td style="border-bottom-width: medium; border-bottom: 1px solid #111111; " ><?php echo $select_issuer['pan_no']; ?></td>
                    </tr>
                    <tr ><td width="80px;" >GST Number</td>
        ...
        $select_customer = mysql_fetch_array($result_customer);
                    ...
                    <tr>
                        <td valign="top" width="80px;">Name</td><td valign="top" style=" border-bottom: 1px solid #111111;" ><?php echo $select_customer['full_name']; ?></td>
                    </tr>
                   <!-- <tr ><td valign="top" >Company</td>
                    ...
                    <tr ><td valign="top" >Address:</td>
                        ...
                        <textarea rows="3" cols="42" id="multiLineInput" class=""  style=" border-right: 0px;  border-bottom: 0px;  border-left: 0px;  border-top: 0px; line-height: 4ch;  background-image: linear-gradient(transparent, transparent calc(4ch - 1px), #111111 0px);background-size: 100% 4ch; 0px;   "><?php echo $select_customer['current_address']; ?></textarea></td>
                    </tr>
                   
                    <tr ><td valign="top" >Client GST</td>
                    ...
                    <tr ><td valign="top" width="80px;" >Invoice Date</td>
                    ...
                    <tr ><td valign="top" >Client Contact</td>
                    ...
                    <tr ><td valign="top" >Client Email</td>
                    ...
                    <tr ><td valign="top">Customer Id</td>
       ...
       <table width="100%" border="0">
        <tr>
         ...
         Any queries relating to this invoice should be directed to the Invoice contact detailed below.<br><br>
        </div>
       ...
       <tr>
        <td align="center">
         ...
         <br>E & O.E&nbsp;&nbsp;&nbsp;&nbsp; Our invoice contact : <?php echo $select_issuer['display_name']; ?>
         , Ph: <?php echo $select_issuer['mobile']; ?>  and email address : <?php echo $select_issuer['email']; ?>
         </div>
        </td>
       </tr>
