...
<table width="100%" style="padding:30px;" >
  ...
  <table width="100%" class="tbl_border" >
    ...
    <table width="95%">
            ...
            <tr><td > Date</td>
            <td>
                <input type="text"  name="file_date" style="width:250px;" id="file_date" value="<?php echo $_REQUEST['file_date']; ?>" autocomplete="off" />&nbsp;<img src="js/images2/cal.gif" onClick="javascript:NewCssCal('file_date')" style="cursor:pointer"/>
