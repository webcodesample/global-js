...
*/
				...
				*/
				...
				$query="insert into payment_plan set trans_id = '".$trans_id."', cust_id = '".$cust_id."', debit = '".$amount."', gst_amount = '".$amount_gst_amount."', description = '".$description."', on_project = '".$project_id."', payment_date = '".strtotime($payment_date)."',subdivision = '".$subdivision."',trans_type = '".$trans_type."', trans_type_name = '".$trans_type_name."', create_date = '".getTime()."'";
				$result= mysql_query($query) or die('error in query '.mysql_error().$query);
				
				$link_id_1 = mysql_insert_id();
				
				$query2="insert into payment_plan set trans_id = '".$trans_id."', project_id = '".$project_id."', credit = '".$amount."', gst_amount = '".$amount_gst_amount."', description = '".$description."', on_customer = '".$cust_id."', payment_date = '".strtotime($payment_date)."',link_id = '".$link_id_1."',subdivision = '".$subdivision."',trans_type = '".$trans_type."', trans_type_name = '".$trans_type_name."', create_date = '".getTime()."'";
				$result2= mysql_query($query2) or die('error in query '.mysql_error().$query2);
				...
				while($select_data = mysql_fetch_array($select_result))
				{
					...
					<?php
					 ...
					 <option value="new">New</option>
						...
						<td class="data"><input style="width: 100px;"  type='text' value="" id="<?php echo "amount_gstper_n$inm"; ?>" name='amount_gstper_n[]'/></td>
						<td class="data"><input style="width: 100px;"  type='text' value="" id="<?php echo "amount_gst_amount_n$inm"; ?>" name='amount_gst_amount_n[]'/></td>
						<td class="data"><input style="width: 100px;"  type='text' value="" id="<?php echo "amount_grand_n$inm"; ?>" name='amount_grand_n[]'/></td>
