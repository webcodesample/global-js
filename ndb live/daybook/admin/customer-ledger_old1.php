...
*/
           ...
           //invoice_due_des_1 , pay_payment_date
...
<div id="tds_due_div" style="position:absolute;top:50%; left:40%; width:550px; height:480px; margin:-100px 0 0 -50px;z-index:100; display:none; background-color:#FFFFFF; border:8px solid #999999;" >
...
<tr>
                ...
                <tr>
                    ...
                    <table width="100%" cellpadding="0" cellspacing="0" >
                        <tr>
                            <td width="250px" style="color:#blue; " ><b>Clear TDS Due :</b>&nbsp;&nbsp; <input type="checkbox" id="clear_tds_due" name="clear_tds_due" onClick="return clear_tds_desc();" value="yes"></td>
                            <td width="400px">&nbsp;</td>
                            <td>&nbsp;</td>
                        </tr>
                        <tr id="clear_desc_display_tds" style="display:none;">
                            <td width="250px">Description</td>
                            <td width="400px"><input type='text' style="display:none; width=300px;" name='clear_tdsdue_desc' align='right' id='clear_tdsdue_desc' width="300px" placeholder="Type clear due Description here"/>
                            
                    </td><td>&nbsp;</td>
                    </tr>
                        <tr id="clear_date_display_tds" style="display:none;">
                        <td width="250px">Payment Date</td>
                        <td  ><input type='text' style=" width=100px;" name='clear_pay_payment_date_tds' align='right' id='clear_pay_payment_date_tds' width="50px" autocomplete="off" placeholder="Type clear due Payment Date here" /></td>
...
<tr><td valign="top" width="300px" ><b>Received TDS Certificate</b></td>
 ...
 <!-- /// attach_div  ,attach_form ,  attach_form ,  attach_validation , attach_file_id   , invoice_flag  -->    
<div id="gst_due_div" style="position:absolute;top:50%; left:40%; width:550px; height:480px; margin:-100px 0 0 -50px;z-index:100; display:none; background-color:#FFFFFF; border:8px solid #999999;" >
...
<table cellpadding="0" cellspacing="0" border="1px" width="100%" >
    <tr><td valign="top" align="right" colspan="2" ><img src="images/close.gif" onClick="return close_gst_div();" ></td></tr>
                ...
                <tr>
                    ...
                    <table width="100%" cellpadding="0" cellspacing="0" >
                        <tr>
                            <td width="250px" style="color:#blue; " ><b>Clear GST Due :</b>&nbsp;&nbsp;<input type="checkbox" id="clear_gst_due" onClick="return clear_gst_desc();" name="clear_gst_due" value="yes"></td>
                            <td width="400px">&nbsp;</td>
                            <td>&nbsp;</td>
                        </tr>
                        <tr id="clear_desc_display_gst" style="display:none;">
                            <td width="250px">Description</td>
                            <td width="400px"><input type='text' style="display:none; width=300px;" name='clear_gstdue_desc' align='right' id='clear_gstdue_desc' width="300px" />
                            
                    </td><td>&nbsp;</td>
                    </tr>
                        <tr id="clear_date_display_gst" style="display:none;">
                        <td width="250px">Payment Date : </td>
                        <td><input type='text' style="width=100px;" name='clear_pay_payment_date_gst' align='right' id='clear_pay_payment_date_gst' width="50px" autocomplete="off" placeholder="Type clear due Payment Date here"/></td>
            ...
            <tr><td valign="top" width="300px" ><b>Received gst :</b></td>
 ...
 <!-- /// attach_div  ,attach_form ,  attach_form ,  attach_validation , attach_file_id   , invoice_flag  -->    
<div id="invoice_due_div" style="position:absolute;top:50%; left:40%; width:500px; height:530px; margin:-100px 0 0 -50px;z-index:100; display:none; background-color:#FFFFFF; border:8px solid #999999;" >
...
<tr>
                ...
                <tr>
                    ...
                    <table width="100%" cellpadding="0"  cellspacing="0">
                        <tr>
                            <td width="250px" style="color:#blue; " ><b>Clear Invoice Due :</b>&nbsp;&nbsp;<input type="checkbox" id="clear_invoice_due" name="clear_invoice_due" onClick="return clear_invoice_desc();" value="yes">
                            <td width="400px">&nbsp;</td>
                            <td>&nbsp;</td>
                        </tr>
                        <tr id="clear_desc_display" style="display:none;">
                            <td width="250px">Description</td>
                            <td width="400px"><input type='text' style="display:none; width=300px;" name='clear_invoicedue_desc' align='right' id='clear_invoicedue_desc' width="300px" />
                            
                    </td><td>&nbsp;</td>
                    </tr>
                        <tr id="clear_date_display" style="display:none;">
                        <td width="250px">Payment Date</td>
                        <td align="left" ><input type='text' style="display:none; width=100px;" name='clear_pay_payment_date' align='right' id='clear_pay_payment_date' width="50px" autocomplete="off" /></td>
...
<tr><td valign="top" width="300px" ><b>Received Due Invoice Amount</b></td>
