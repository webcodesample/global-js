...
<div id="wrapper">
    ...
    <h3>Purchase Goods List <span style="float: right;">
    ...
    $select_total3 = mysql_num_rows($search_result3);
        ...
        <table class="data" id="my_table" border="1" cellpadding="1" cellspacing="0" style="border: 1px solid #111111;">
            ...
            <thead class="report-header">
                ...
                <th style="display:none;" class="data">Gst Amount</th>
            ...
            if($select_total > 0)
            {
                ...
                while($select_data = mysql_fetch_array($select_result))
                {
                    ...
                    <tr class="data">
                        ...
                        <td style="display:none;" class="data"><?php echo $select_data['debit']-$select_data['gst_amount']; ?></td>
                        ...
                        echo $gstper; ?></td>
                        <td style="display:none;" class="data"><?php echo $select_data['gst_amount']; ?></td>
                        <td class="data"><?php echo $select_data['debit']; ?></td>
